		  ...
		  <div class="col-md-3" style="text-align:center">
		   ...
		   <div class="marketCompare1" id="marketCompare1" style="display:none">
			...
			<div class="form-group" id="player1box" class="manualCompare1">
				...
				<h4>Mother club bonus  <i class='player1 fa fa-heart manual1' id="motherClubBonus1" style='color: rgb(179, 179, 179)' onclick="changeStyle(this,1);recomputeValue(1, 'other')"></i></h4>
		...
		<div class="col-md-3" style="text-align:center">
		   <br>
			...
			<div class="form-group bluePlayer" id="playerbox2" class="manualCompare2">
				...
				<h4>Mother club bonus  <i class='player2 fa fa-heart manual2' id="motherClubBonus2" style='color: rgb(179, 179, 179)' onclick="changeStyle(this,2);recomputeValue(2, 'other')"></i></h4>
...
<script>
	...
	function recomputeValue(player, skill){
		...
		if(playerDetails["motherClubBonus"+player].style.color == "rgb(179, 179, 179)")
			motherClubBonus = 0;
		else 
			motherClubBonus = 0.5;
	...
	function changeStyle(heart, player){
		if(player == 1){
			if(heart.style.color == "green")
				heart.style.color = "rgb(179, 179, 179)";
