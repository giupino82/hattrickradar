<?php
	...
	if(isset($_SESSION['HT'])){
	  ...
	  if($player->isSkillsAvailable()){
		  ...
		  $player1Description.="<h4>Stamina:  <input type='number' id='stamina1' min='1' max='9' class='player".$_POST['playerNum']." slider slidermarket".$_POST['playerNum']."  char".$_POST['playerNum']."' onchange=\"recomputeValue(".$_POST['playerNum'].", 'other')\" value=".$stamina."></h4><br>";
		  $player1Description.="<h4>Player form <br><input id='form".$_POST['playerNum']."' class='player".$_POST['playerNum']." slider  slidermarket".$_POST['playerNum']." char".$_POST['playerNum']."' onchange=\"recomputeValue(".$_POST['playerNum'].", 'other')\" type='text' data-slider-min='1' data-slider-max='8' data-slider-step='1' data-slider-value='".$form."'/><br>";
		  $player1Description.="<h4>Experience <br><input id='experience".$_POST['playerNum']."' class='player".$_POST['playerNum']." slider  slidermarket".$_POST['playerNum']." char".$_POST['playerNum']."'  onchange=\"recomputeValue(".$_POST['playerNum'].", 'other')\" clatype='text' data-slider-min='1' data-slider-max='20' data-slider-step='1' data-slider-value='".$experience."'/><br>";
		  $player1Description.="<h4>Loyalty <br><input id='loyalty".$_POST['playerNum']."' class='player".$_POST['playerNum']." slider  slidermarket".$_POST['playerNum']." char".$_POST['playerNum']."'  onchange=\"recomputeValue(".$_POST['playerNum'].", 'other')\" type='text' data-slider-min='1' data-slider-max='20' data-slider-step='1' data-slider-value='".$loyalty."'/><br>";
		  ...
		  foreach($skillArray as $value){
			  ...
			  $player1Description.="<h4>".$skillArrayName[$i]." <br><input id='".$skillArrayName[$i].$_POST['playerNum']."' class='player".$_POST['playerNum']." slider  slidermarket".$_POST['playerNum']." char".$_POST['playerNum']."'  onchange='recomputeValue(".$_POST['playerNum'].",".$skillArrayName[$i].")' type='text' data-slider-min='1' data-slider-max='20' data-slider-step='1' data-slider-value='".$skillArray[$i] ."'/><br>";
